defmodule PhxBlogWeb.UserControllerTest do
  use PhxBlogWeb.ConnCase

  import PhxBlog.AccountsFixtures

  alias PhxBlog.Accounts.User
  alias PhxBlog.Accounts.Guardian
  ...
  defp create_session(%{conn: conn}) do
    ...
    {:ok, token, _claims} = Guradian.encode_and_sign(user)
